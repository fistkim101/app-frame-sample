package com.fistkim.discovery.config;
...
public class SecurityConfiguration implements WebSecurityCustomizer {
    ...
    public SecurityConfiguration(SecurityInMemoryAuthentication.SecurityUser actuatorUser, SecurityInMemoryAuthentication.SecurityUser adminUser) {
